<template>
  <div class="container mx-auto mt-24">
    <section class="bg-white m-10 p-10 rounded-lg">
      ...
      <div class="my-5">
        <h2 class="text-xl font-bold">第4条（ログイン情報の管理）</h2>
        <p class="mb-2 ml-4">
      ...
      <div class="my-5">
        ...
        <p class="mb-2 ml-4">
          当局は、ユーザーに対し、本サービスが提供する文章、画像、動画、音声、音楽、ソフトウェア、プログラム、コードその他のコンテンツについて、本サービスの利用範囲内における私的な利用を許諾します。有償コンテンツについては、当局が定める利用料金の支払が完了した場合に、本サービスの利用範囲内における私的な利用を許諾します。これは、譲渡及び再許諾できない、非独占的な利用権です。この範囲を超えて本サービスが提供するコンテンツを利用することは一切禁止します。
          <br />
      ...
      <div class="my-5">
        <h2 class="text-xl font-bold">第11条（退会）</h2>
        <p class="ml-4">
          ユーザーは、当局の定める手続により、利用登録を抹消し、本サービスから退会できるものとします。
        </p>
      </div>

      <div class="my-5">
        <h2 class="text-xl font-bold">第12条（保証の否認）</h2>
        <p class="ml-4">
      ...
      <div class="my-5">
        <h2 class="text-xl font-bold">第13条（免責）</h2>
        <p class="ml-4">
        ...
        <p class="ml-4">
          当局は、本サービスに関してユーザーが被った損害につき、当該損害が発生した月内にユーザーが当局に支払った利用料金を超えて賠償する責任を負わないものとします。
        </p>
      </div>

      <div class="my-5">
        <h2 class="text-xl font-bold">第14条（サービス内容の変更）</h2>
        <p class="ml-4">
      ...
      <div class="my-5">
        <h2 class="text-xl font-bold">第15条（利用規約の変更）</h2>
        <p class="ml-4">
      ...
      <div class="my-5">
        <h2 class="text-xl font-bold">第16条（個人情報の取扱い）</h2>
        <p class="ml-4">
      ...
      <div class="my-5">
        <h2 class="text-xl font-bold">第17条（通知または連絡）</h2>
        <p class="ml-4">
      ...
      <div class="my-5">
        <h2 class="text-xl font-bold">第18条（権利義務の譲渡）</h2>
        <p class="ml-4">
      ...
      <div class="my-5">
        <h2 class="text-xl font-bold">第19条（適用関係）</h2>
        <p class="ml-4">
      ...
      <div class="my-5">
        <h2 class="text-xl font-bold">第20条（分離可能性）</h2>
        <p class="ml-4">
      ...
      <div class="my-5">
        <h2 class="text-xl font-bold">第21条（準拠法・裁判管轄）</h2>
