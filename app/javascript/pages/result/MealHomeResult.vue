<template>
  ...
  >
    <div class="p-3 mt-5">
      ...
      <p>
        配達中にカロリーは道に落ちるので，デリバリーされた食べ物による摂取カロリーは<span
          class="text-3xl font-bold"
          >0kcal</span
        >です。
      </p>
      <p v-if="allDescriptions" class="text-2xl font-bold">
    ...
    <div class="p-3 mt-2">
      ...
      <p>
        ランキングが高いとみんなに支持されているということなのでカロリーが分散するので、こちらの食品から摂取したカロリーは<span
          class="text-3xl font-bold"
          >0kcal</span
        >です。
      </p>
    ...
    <div class="p-3 mt-2">
      ...
      <p>
        ん〜，何故かはよく分かりませんが甘いので，こちらのスイーツから摂取したカロリーは<span
          class="text-3xl font-bold"
          >0kcal</span
        >です。
      </p>
    ...
    <div class="p-3 mt-2">
      ...
      <p>
        自分で料理をすると食材と向き合うことになるので，こちらのレシピで作った料理の摂取カロリーは<span
          class="text-3xl font-bold"
          >0kcal</span
        >です。
      </p>
